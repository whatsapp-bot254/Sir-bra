    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "sir bravin~" + string_session;
                        let code = await sock.sendMessage(sock.user.id, { text: md });
                        let desc = `*sir bravin manufactur! 👋🏻* 
...
https://github.com/whatsapp-bot254/whatsapp-xmd
...
externalAdReply: {
title: "sir bravin",
thumbnailUrl: "https://files.catbox.moe/huqk1i.jpg",
